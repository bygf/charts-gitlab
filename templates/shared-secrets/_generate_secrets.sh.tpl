...
# Postgres password
generate_secret_if_needed {{ template "gitlab.psql.password.secret" . }} --from-literal=password=$(gen_random 'a-zA-Z0-9' 64) --from-literal=postgres-password=$(gen_random 'a-zA-Z0-9' 64)
{{ end }}
